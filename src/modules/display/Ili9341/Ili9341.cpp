   ...
   public:
    Ili9341(String parameters) : IoTItem(parameters) {
        ...
        tft.begin(); 
          ...
          tft.setRotation(_rotation);    //Landscape
        ...
        jsonRead(parameters, "rotation", _rotation);//_shrift
...
/*
       ...
       tft.begin();
        ...
        jsonRead(parameters, "scale", _scale);
        jsonRead(parameters, "scale1", _scale1);
    ...
    void doByInterval()
    {
        ...
        angle = constrain(angle, _scale, _scale1); //привести к мин и макс темппературе, пример: если больше 50, то будет 50

       // angle = constrain(angle, 0, 240); //привести к мин и макс темппературе, пример: если больше 50, то будет 50

        angle = map(angle, _scale, _scale1, 0, 240);  // привести к углу, 0темп=0угол .... 50темп=240угол  

       // angle = map(angle, 0, 240, 0, 240);  // привести к углу, 0темп=0угол .... 50темп=240угол  
           ...
           //    else _colour21 = WHITE;
             ...
             //  tft.drawLine(a, b, c, d, _colour21);
              ...
              //  int d = param[3].valD;
               ...
               //======================================================================================
   int hh = _time_local.hour;                                                                         // hours variable
   int mm = _time_local.minute;                                                                        // minutes variable
   int ss = _time_local.second;  

   //Serial.print ("Time : ");
   //Serial.print (_time_local.hour);
   //Serial.print (" : ");
   //Serial.println (_time_local.minute); 
